...
public class Generator {
    ...
    private static final String PACKAGE_NAME = "table";
    ...
    private static DataSourceConfig getDevCoach() {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/onlinechat?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&failOverReadOnly=false&rewriteBatchedStatements=true");
        return dsc;
    }
